...
const exact: SubmittedBuildCaptureFreeze = {
  ...
  rationale:
    "Exact build 7 was already WAITING_FOR_REVIEW and must not be replaced, cancelled, edited, or resubmitted. The post-publication Garden and timer audio correction are deliberately not represented by the submitted App Store screenshots; App Store Connect remained untouched, and fresh captures are required at the next editable metadata opportunity.",
};
