...
assert.equal(isExactPostPublicationGardenLabFreeze(withAttestation({ fresh_browser_matrix: "skipped-host-denial-not-passed" }), currentSourceSha256), false, "the fresh 60-render proof must not be downgraded");
